...
func nav() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<nav class=\"bg-blue-600 p-4\"><button class=\"text-gray-200\" hx-post=\"/partial\" hx-target=\"#main-contents\" hx-swap=\"innerHTML\" hx-replace-url=\"/\">Home</button> <button class=\"text-gray-200\" hx-post=\"/about/partial\" hx-target=\"#main-contents\" hx-swap=\"innerHTML\" hx-replace-url=\"/about\">About</button></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func Layout(contents templ.Component, title string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<main class=\"flex-1\"><div id=\"main-contents\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
